...
activated and inhibited by globus pallidus deep brain stimulation." *J Neurophys.*
...
GPi neuron model (implemented from tracing in Fig4, Parent2001, *J Comp Neurol*)

GPe axon model (implemented from tracing in Fig5, Sato2000 *J Comp Neurol*)
...
Check that you have NEURON installed (available from [http://www.neuron.yale.edu](http://www.neuron.yale.edu)). Autolaunch from ModelDB **or** download
